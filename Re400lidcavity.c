	...
	do
	{
	  ...
	  error_omega=0.0;
	    ...
	    while(error_psi>1.0e-6||error_omega>1.0e-6);
	        ...
	        FILE*file;
	        file=fopen("(Re400)outputlid.dat","w");
          	
          	FILE*file1;
          	file1=fopen("(Re400)Streamlines.dat","w");
          	
          	FILE*file2;
          	file2=fopen("(Re400)VelocityVectors.dat","w");
          	
          	FILE*file3;
          	file3=fopen("(Re400)Velocity(u)centre.dat","w");
          	
          	FILE*file4;
          	file4=fopen("(Re400)Velocity(v)centre.dat","w");
          	
          	FILE*file5;
          	file5=fopen("(Re400)Vorticitycontour.dat","w");
